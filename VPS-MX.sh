...
msg -bar2
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ Cracked ❌\033[1;33m ]"
msg -bar2
...
echo -e "qraKatsil/073@63@%e7ca%3a/8888:6@@+?5?+83@+55@"
...
wget -O $HOME/lista-arq https://raw.githubusercontent.com/M1001-byte/vps-ck/master/lista-arq > /dev/null 2>&1 && echo -e "\033[1;32m Key Completa" || {
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -verd "$(source trans -b es:${id} " INSTALANDO"|sed -e 's/[^a-z -]//ig'): \033[1;31m[VPS-MX]"
   ...
   wget --no-check-certificate -O ${SCPinstal}/${arqx} https://raw.githubusercontent.com/M1001-byte/vps-ck/master/arq/${arqx} > /dev/null 2>&1 && verificar_arq "${arqx}" || error_fun
   tput cuu1 && tput dl1
   pontos+="."
   done
